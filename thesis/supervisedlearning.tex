...
\begin{figure}
	...
	\caption{Illustration of the bias and variance. On the left-hand side, the predicted values of a two-dimensional high variance low-bias model (blue) and low variance high-bias model are illustrated. On the right-hand side, the bias-variance decomposition is shown.}
\end{figure}
