...
\begin{table}[H]
	\caption{The CPU time (in seconds) per iteration when simulating two-dimensional quantum dots with $N=2-90$ electrons. The time was clocked for $M=2^{20}=1,048,576$ Monte Carlo cycles, and to get accurate times we took the average over at least four independent runs with thousands of iterations.}
	\label{tab:cputime2D}
...
\begin{table}[H]
	\caption{The CPU time (in seconds) per iteration when simulating three-dimensional quantum dots with $N=2-70$ electrons. The time was clocked for $M=2^{20}=1,048,576$ Monte Carlo cycles, and to get accurate times we took the average over at least four independent runs with thousands of iterations.}
	\label{tab:cputime3D}
