...
\end{empheq}
is given in Hartree atomic units which also is discussed in Appendix B. For the non-interacting case, the energy of a particle in shell $n$ is given by the Bohr formula\supercite{griffiths_introduction_2005}
\begin{equation}
E_n=-\frac{Z^2}{2n^2}.
