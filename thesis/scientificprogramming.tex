...
public:
	...
	virtual ~Shapes() = 0;								// Pure virtual destructor
};

class Circle : public Shapes {
public:
	Circle(double r) { m_r = r; }						// Constructor of Circle
...
public:
	Square(double r) { m_r = r; }						// Constructor of Square
	...
	~Square() {}										// Destructor of Square
private:
	double m_r = 1;
};

Shapes::~Shapes() {}									// Destructor of Shapes
\end{lstlisting}
...
\begin{table}
	\caption{Built-in data types in C++, with their memory occupation and range in a 64-bit processor, taken from Ref. \cite{noauthor_c++_2017}. Extensions in the parenthesis are optional.}
	\label{tab:datatypes}
