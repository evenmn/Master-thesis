...
This appendix is meant as a more or less complete collection of the results obtained in this thesis, with the purpose of presenting a complementary picture of the observations. This also allows us to include the (subjective) most important results in the chapter on selected results, \ref{chp:results}, and avoid it to be too overwhelming. However, in this appendix, the results will simply be listed and not commented on and discussed.
