\definecolor{listingsstringcolor}{rgb}{0.274509803921569,0.470588235294118,0.129411764705882}
\definecolor{listingskeywordcolor}{rgb}{0.203921568627451,0.541176470588235,0.741176470588235}
...
\definecolor{listingscommentcolor}{rgb}{0.47843137254902,0.407843137254902,0.650980392156863}
...
\lstset {
  ...
  %   numbers=left,                    % where to put the line-numbers; possible values are (none, left, right)
    postbreak=\raisebox{0ex}[0ex][0ex]{\ensuremath{\color{color1}\hookrightarrow\space}},
...
\input{package-config/listings-std.tex}
\input{package-config/listings-python-std.tex}
