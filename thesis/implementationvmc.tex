...
\begin{equation}
\Psi_{\text{sd}}(\bs{R})=|\hat{D}_{\sigma}(\bs{R})|=\frac{1}{\sqrt{N}}
\begin{vmatrix}
...
\begin{equation}
\Psi_{\text{sd}}(\bs{R})=\frac{1}{\sqrt{N}}\sum_{q}(-1)^q\hat{P}\phi_1(\bs{r}_1)\phi_2(\bs{r}_2)\hdots\phi_N(\bs{r}_N),
\label{eq:slatersum}
\end{equation}
...
\begin{equation}
\begin{aligned}
\Psi_{\text{sd}}(\bs{R})&=\frac{1}{\sqrt{N}}\sum_{p}(-1)^p\hat{P}f_1(\bs{r}_1)g(\bs{r}_1)f_2(\bs{r}_2)g(\bs{r}_2)\hdots f_N(\bs{r}_N)g(\bs{r}_N)\\
