...
\draw[color0,thick,-] (b) to [out=270,in=90] (h21);
\draw[color0,thick,-] (b) to [out=315,in=45] (h22);
\draw[color0,thick,-] (b) to [out=0,in=0] (h23) node[] at (9,1) {$b_3^2$};
...
\draw[color2,thick,-] (c) to [out=235,in=125] (x1);
\draw[color2,thick,-] (c) to [out=305,in=55] (x2);
\draw[color2,thick,-] (c) to [out=190,in=170] (x3) node[] at (1.8,3.2) {$a_3$};
