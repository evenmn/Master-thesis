\begin{figure} [H]
	...
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	\caption{The possible states of a two-dimensional quantum dot for $n=n_x+n_y=0,1,2,3$. Recalling that the electrons can have spin $\pm 1$, one can use this schematic to determine how many electrons there are in each closed shell and thus find the magic numbers.}
	\label{fig:hostates}
\end{figure}