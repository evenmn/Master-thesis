...
\path[draw,color2,thick,-] (x1) -- (x2) node[midway, above left] {$c_{12}$};
\path[draw,color2,thick,-] (x2) -- (x3);
\path[draw,color2,thick,-] (x3) -- (x1);

\draw[color0,thick,-] (b) to [out=270,in=90] (h1);
\draw[color0,thick,-] (b) to [out=315,in=45] (h2);
\draw[color0,thick,-] (b) to [out=0,in=0] (h3)  node[] at (6,1) {$b_3$};
