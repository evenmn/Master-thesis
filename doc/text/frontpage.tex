...
\newpage
\vfill
As long as nothing else is specified, the illustrations are creating using the TikZ package.

Plotting is done in Matplotlib and PGFPlots. 

Typesetting was done in \LaTeX
\newpage
\section*{Abstract}
