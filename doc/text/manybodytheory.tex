...
\end{equation}
which is the farthest we can go without specifying the external potential $V_{\text{ext}}^i$. $r_{ij}$ is the relative distance between particle $i$ and $j$, defined by $r_{ij}\equiv|\bs{r}_i-\bs{r}_j|$.
