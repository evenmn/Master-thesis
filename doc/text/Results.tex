...
The last ting we will investigate, is the two-body density. See figure \eqref{fig:TB_interaction_2D}.
...
We will now look at some special cases for the quantum dots, including low frequency, large dots (many electrons) and quantum dots in a medium. 
