...
\begin{table}
	...
	\begin{tabularx}{\hsize}{llR{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.2cm}} \hline\hline
		...
		& 0.5 & 275.262(7) & 271.030(4) & - & & - & 269.621(2) \\
		& 1.0 & 452.732(8) & 442.874(4) & - & & - & 442.233(1) \\ \hline\hline
	\end{tabularx}
\end{table}
\end{landscape}
}
...
\begin{landscape}
	\begin{figure} [H]%
		...
		\subfloat[RBM+PJ, $\omega=0.1$]{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/twobody/2D/20P/0.100000w/RBMPJ_ADAM_MC2pow28.png}}
		...
		\subfloat[RBM+PJ, $\omega=0.5$]{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/twobody/2D/20P/0.500000w/RBMPJ_ADAM_MC2pow28.png}}
