...
\begin{table}
	...
	\begin{tabularx}{\hsize}{llR{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}} \hline\hline
		...
		2 & 0.1 & 0.4728(1) & 0.44859(6) & 0.44130(5) & 0.4959(2) & 0.525635 & - & 0.44129(1) & 0.44079(1) \\ 
		& 1/6 & 0.7036(1) & 0.67684(7) & 0.66715(6) & 0.7326(2) & 0.768675 & - & 0.66710(1) & $0.\bar{6}^{1}$ \\
		& 0.28 & 1.0705(2) & 1.03485(7) & 1.02185(1) & 1.0987(2) & 1.14171 & - & 1.02192(1) & 1.02164(1) \\
		& 0.5 & 1.7231(2) & 1.67787(8) & 1.65957(1) & 1.7182(3) & 1.79974 & - & 1.65974(1) & 1.65977(1)  \\
		...
		& 0.5 & 12.242(1) & 11.9659(5) & 11.8113(2) & 11.995(3) & 12.2713 & - & 11.8104(2) & 11.78484(6) \\
		& 1.0 & 20.731(1) & 20.4061(7) & 20.1853(2) & 20.483(1) & 20.7192 & - & 20.1918(2) & 20.15932(8) \\ \hdashline \\
...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{R{1.5cm}rrcR{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}} \hline\hline
		...
		&12 & 0.01 && 2.4972(2) & 0.048721(2) & 0.8968(1) & 1.55170(9)\\
		&& 0.1 && \\
		&& 0.5 && \\
		&& 1.0 && \\
		&& 3.0 && \\ \hdashline \\
		
		&20 & 0.01 && 6.407(6) & 0.048011(1) & 2.182(3) & 4.177(3) \\
		&& 0.1 && \\
		&& 0.5 && \\
		&& 1.0 && \\
		&& 3.0 && \\ \hline \hline
