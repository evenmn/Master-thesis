...
\begin{table}
	\caption{Double quantum dots. F is number of functions used in the expansion.}
	\label{tab:doubleQD}
	\begin{tabularx}{\textwidth}{rrXR{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}} \hline\hline
		...
		2 & 1.0 && 2.6331(5) & 2.38342(3) & 2.42238(4) & 2.36618(4) & 2.3496(1) \\ \hline \\
		4 & 1.0 && - & - & 7.95247(4) & 7.90232(4) & - \\ \hline \\
		6 & 1.0 && - & - & 16.61419(4) & 16.55609(4) \\ \hline \\
		8 & 1.0 && - & - & \\ \hline \hline
	\end{tabularx}
\end{table}
