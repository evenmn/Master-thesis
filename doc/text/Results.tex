	...
	\begin{landscape}
		...
		\begin{table}
			\begin{tabularx}{\hsize}{llR{2.65cm}R{2.65cm}R{2.65cm}R{2.65cm}R{2.65cm}R{2.65cm}R{2.65cm}} \\
				...
				& 1.0 & 315.364(8) & 309.997(6) & 308.989(2) & & 308.576(1) & 308.5627(2) \\ \hdashline \\
				...
				& 1.0 & 553.40(1) & 545.817(9) & 543.746(3) & & 542.977(2) & 542.9428(8) \\ \hdashline \\
...
\begin{figure}[H]
	...
	\subfloat{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/6P/0.010000w/RBMPJ_ADAM_MC2pow28_smooth_blue_small}}}\\ [-0.cm]
...
From figure \eqref{fig:energydistribution} we also observe that the  As we discussed already in section \ref{sec:wigner}, we expect the interactions to be important when the 

Above, we have seen intimations to some change in the electron density as the oscillator frequency gets low, where the one-body density apparently is shape-invariant for high frequencies including $\omega=0.28$.  down to a certain frequency around . In particular, we can see that the density plots for $\omega=0.1$ in figure \eqref{fig:OB_interaction} differ from the others, 

and in this section we will take a closer look at this phenomenon by looking at decreasing frequencies around the transition point and down to $\omega=0.01$. 
