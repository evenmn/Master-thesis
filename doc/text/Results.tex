...
\begin{figure}
	...
	\subfloat[2D]{\includegraphics[width=\textwidth/2]{/home/evenmn/VMC/plots/int0/onebody/2D/2P/GD_MC2pow30_w1p0.png}}
	\subfloat[3D]{\includegraphics[width=\textwidth/2]{/home/evenmn/VMC/plots/int0/onebody/3D/2P/GD_MC2pow30_w1p0.png}}\\
	
	\subfloat[VMC]{\includegraphics[width=\textwidth/2]{/home/evenmn/VMC/plots/int0/onebody2/2D/2P/1.000000w/VMC_GD_MC2pow30_blue_small.png}}
	\subfloat[RBM]{\includegraphics[width=\textwidth/2]{/home/evenmn/VMC/plots/int0/onebody2/2D/2P/1.000000w/RBM_ADAM_MC268435456.png}}
...
\begin{figure}
	...
	\caption{One-body density of two-dimensional circular quantum dots of frequencies $\omega=0.28$, 0.1 and 0.01 with $N=2$ electrons. The surface plots are noise-reduced using a Savitzky-Golay filter, and for abbreviations see the text.}
	\label{fig:lowfreq2P}
\end{figure}
