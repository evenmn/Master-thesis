...
\begin{figure}[h]
	\centering
	\subfloat[VMC]{{\includegraphics[width=\textwidth/3]{/home/evenmn/VMC/plots/int0/onebody2/2D/2P/1.000000w/VMC_GD_MC2pow30_notsmooth.png} }}
...
\begin{figure}
	\centering
	\subfloat[VMC]{{\includegraphics[width=7cm]{/home/evenmn/VMC/plots/int0/twobody/VMC/2D/2P/1.000000w/VMC_GD_MC2pow28.png} }}
...
\begin{figure}
	...
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/2P/1.000000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.0cm}
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/2P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}\\
	
	\subfloat{\raisebox{2.5cm}{\rotatebox[origin=t]{90}{6P}}}\hspace{0.05cm}
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/6P/1.000000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.0cm}
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/6P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}\\
	
	\subfloat{\raisebox{2.5cm}{\rotatebox[origin=t]{90}{12P}}}\hspace{0.1cm}
	\subfloat[VMC]{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/12P/1.000000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.0cm}
	\subfloat[RBM]{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/12P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}
...
\begin{figure}
	...
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/20P/1.000000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.0cm}
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/20P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}\\
	
	\subfloat{\raisebox{2.5cm}{\rotatebox[origin=t]{90}{30P}}}\hspace{0.1cm}
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/30P/1.000000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.0cm}
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/30P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}\\
	
	\subfloat{\raisebox{2.5cm}{\rotatebox[origin=t]{90}{42P}}}\hspace{0.1cm}
	\subfloat[VMC]{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/42P/1.000000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.0cm}
	\subfloat[RBM]{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/42P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}
...
\begin{figure}[H]
	...
	\subfloat{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/2P/0.010000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.5cm}
	\subfloat{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/2P/0.010000w/RBMPJ_ADAM_MC2pow28_smooth.png}}}\hspace{-0.5cm}
	...
	\subfloat[VMC]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/6P/0.010000w/VMC_ADAM_MC2pow28_smooth.png}}}\hspace{-0.5cm}
	\subfloat[RBM+PJ]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/6P/0.010000w/RBMPJ_ADAM_MC2pow28_smooth.png}}}\hspace{-0.5cm}
...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{lrrR{2cm}R{2cm}R{2cm}R{2cm}R{2cm}} \hline\hline
		Atom & $Z$ & \makecell{\\ \phantom{=}} & \multicolumn{1}{c}{$\langle\hat{H}\rangle$} & \multicolumn{1}{c}{$\langle\hat{T}\rangle$} & \multicolumn{1}{c}{$\langle\hat{V}_{\text{ext}}\rangle$} & \multicolumn{1}{c}{$\langle\hat{V}_{\text{int}}\rangle$} & 
		\multicolumn{1}{c}{Expt.} \\ \hline \\
		
		He & 2 && -2.8535(1) & 3.268(1) & -7.228(2) & 1.1065(3) & $-2.903694^a$ \\
		Be & 4 && -14.4992(5) & 15.465(6) & -34.987(7) & 5.023(1) & $-14.6674^b$ \\
		Ne & 10 && - & - & - & - & $-128.9383^c$ \\ \hline\hline
	\end{tabularx}
\end{table}
...
\begin{figure}
	\centering
	\captionsetup[subfigure]{labelformat=empty}
	\subfloat[He]{\includegraphics[width=\textwidth/2]{/home/evenmn/VMC/plots/int1/atoms/He/ADAM_MC2pow28.png}}
	\subfloat[Be]{\includegraphics[width=\textwidth/2]{/home/evenmn/VMC/plots/int1/atoms/Be/ADAM_MC2pow28.png}}
	\label{fig:atomsonebody}
	\caption{Radial one-body density plots obtained for the Helium atom (left-hand side) and the Beryllium atom (right-hand side). VMC was used, which is detailed in the introductory words to this chapter. The number of Monte Carlo cycles used was $M=2^{28}=268,435,456$.}
\end{figure}
