...
\begin{figure}
	...
	\subfloat[6P]{{\includegraphics[width=8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/6P/1.000000w/RBM_ADAM_MC2pow28_smooth.png}}}\\
...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{R{0.5cm}rrcR{2.3cm}R{2.3cm}R{2.3cm}R{2.3cm}R{0.3cm}} \hline\hline
		...
		&& 10.0 && \textcolor{red}{944.1(1)} & 234.4(4) & 383.9(3) & 325.9(1) \\
		\hline\hline
	\end{tabularx}
\end{table}
