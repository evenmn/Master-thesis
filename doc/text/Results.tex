...
\begin{figure}[H]
	...
	\caption{Two-body density plots for two-dimensional circular quantum dots with an even number of closed shells (6, 20 and 42 electrons) and oscillator frequency $\omega=0.5$. The density plots were produced using the methods detailed in the introductory words to this chapter. The ADAM optimizer was used, and after convergence the number of Monte-Carlo cycles was $M=2^{28}=268,435,456$.}%
