...
\begin{figure}
	...
	\caption{One-body density of two-dimensional circular quantum dots of frequency $\omega=0.1$ with $N=2$, 6 and 12 electrons. The graph on the $yz$-plane represent the cross section through $x=0$. The surface plots are noise-reduced using a Savitzky-Golay filter, and for abbreviations see the text.}
