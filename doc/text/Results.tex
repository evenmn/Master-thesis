...
\begin{figure}
	...
	\subfloat{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int0/onebody2/2D/2P/1.000000w/RBM_ADAM_MC268435456.png}}
	\subfloat{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int0/onebody2/2D/2P/1.000000w/VMC_GD_MC2pow30_blue_small.png}}
	\subfloat{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int0/onebody2/2D/2P/1.000000w/Exact.png}}
	
	\subfloat{\raisebox{2.cm}{\rotatebox[origin=t]{90}{Two-body}}}\hspace{0.1cm}
	\subfloat[RBM]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int0/twobody/RBM/2D/2P/1.000000w/RBM_GD_MC2pow30.png}}}
	\subfloat[VMC]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int0/twobody/VMC/2D/2P/1.000000w/VMC_GD_MC2pow30.png}}}
	\subfloat[Exact]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int0/twobody/VMC/2D/2P/1.000000w/exact.png}}}
...
For completeness reasons, we also present the radial one-body density for Helium in figure \eqref{fig:helium_nointeraction}. We see that the produced density curve is more or less identical to the exact density curve, found from the definition in section \eqref{eq:electron_density}.

\begin{figure}[H]
	\centering
	\captionsetup[subfigure]{labelformat=empty}
	\subfloat{\includegraphics[width=9cm]{/home/evenmn/VMC/plots/int0/onebody/helium.png}}
	\caption{Radial one-body density plots for the non-interacting Helium atom produced using VMC. For abbreviations see the text.}
...
\begin{figure}
	...
	\subfloat{{\includegraphics[width=7.8cm]{/home/evenmn/VMC/plots/int1/onebody2/2D/2P/1.000000w/VMC_ADAM_MC2pow28_smooth_blue.png}}}\\
...
\begin{figure}
	\centering
	\captionsetup[subfigure]{labelformat=empty}
	\subfloat{\raisebox{3cm}{\rotatebox[origin=t]{90}{$\omega=0.28$}}}\hspace{0.1cm}
	\subfloat{{\includegraphics[width=8cm]{/home/evenmn/VMC/plots/int1/onebody/2D/20P/0.280000w/ADAM_MC1048576.png}}}\hspace{-0.5cm}
	\subfloat{{\includegraphics[width=8cm]{/home/evenmn/VMC/plots/int1/onebody/2D/42P/0.280000w/ADAM_MC1048576.png}}}\\
...
Nevertheless, someone needs to be the first, and we will use the plots to discuss physics and compare the various methods in the best possible way. Again, we will emphasize that a negative radial distance does not make sense, so all the quadrants are the same and presented in this way to make it more illustrative and intuitive. We will focus on the two-dimensional case, as the three-dimensional case becomes similar in the same way as for the one-body density. 
