...
\end{equation}
where $D$ is the diffusion constant set to $1/2$ in our calculations, and now it is easy to see why. The similarities between the imaginary time Schrödinger and the diffusion equation was noticed by Fermi already in the 1930's, and is what diffusion Monte-Carlo is based on. 