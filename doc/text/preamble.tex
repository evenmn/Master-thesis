...
\newcolumntype{L}{>{\raggedright\let\newline\\\arraybackslash\hspace{0pt}}m{2.45cm}}
...
\usetikzlibrary{through, shapes, calc, shapes, arrows, positioning, arrows.meta, shadows, er, spy}
...
\newcommand{\mtitle}{More Accurate QMC Calculations using Machine Learning}
