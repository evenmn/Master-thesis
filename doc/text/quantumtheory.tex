...
\begin{equation}
\Psi_T(\bs{r}_1,\bs{r}_2)=\frac{1}{\sqrt{2}}
\begin{vmatrix}
\phi_1(\boldsymbol{r}_1) & \phi_2(\boldsymbol{r}_1)\\
\phi_1(\boldsymbol{r}_2) & \phi_2(\boldsymbol{r}_2)
\end{vmatrix}
=\frac{1}{\sqrt{2}}\Big[\phi_1(\boldsymbol{r}_1)\phi_2(\boldsymbol{r}_2)-\phi_2(\boldsymbol{r}_1)\phi_1(\boldsymbol{r}_2)\Big],
\end{equation}
...
\end{vmatrix}
\end{equation}
where the $\phi$'s are the true single particle wave functions, which are the tensor products 
\begin{equation}
\phi=\psi\otimes\chi
\end{equation}
with $\chi$ as the spin part. In the next section, we will proceed further and show how the spin part can be factorized out of a general Slater determinant.
