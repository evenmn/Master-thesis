...
\begin{landscape}
	...
	\begin{figure} [H]%
		...
		\subfloat[RBM, 20P, $\omega=0.1$]{{\includegraphics[width=5.1cm]{Images/example.png}}}
		\subfloat[RBM+SJ, 20P, $\omega=0.1$]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/twobody/2D/20P/0.500000w/RBMSJ_ADAM_MC2pow28.png}}}
		...
		\subfloat[RBM+PJ, 20P, $\omega=0.1$]{\includegraphics[width=5.1cm]{Images/example.png}}
		\subfloat[VMC, 20P, $\omega=0.1$]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/twobody/2D/20P/0.500000w/VMC_ADAM_MC2pow28.png}}}
	...
	\begin{figure} [H]%
		...
		\subfloat[RBM+SJ, 6P,$\omega=0.5$]{\includegraphics[width=5.1cm]{Images/example.png}}
		...
		\subfloat[RBM+PJ, 6P,$\omega=0.5$]{\includegraphics[width=5.1cm]{Images/example.png}}
		...
		\subfloat[RBM+PJ, 12P, $\omega=0.5$]{\includegraphics[width=5.1cm]{Images/example.png}}
	...
	\begin{figure} [H]%
		...
		%\subfloat[RBM+PJ, 20P, $\omega=0.5$]{{\includegraphics[width=5.1cm]{/home/evenmn/VMC/plots/int1/twobody/2D/20P/0.500000w/RBMPJ_ADAM_MC2pow28.png}}}
		\subfloat[RBM+PJ, 20P, $\omega=0.5$]{\includegraphics[width=5.1cm]{Images/example.png}}
	...
	\begin{figure} [H]%
		...
		\subfloat[RBM+SJ, 6P, $\omega=1.0$]{\includegraphics[width=5.1cm]{Images/example.png}}
