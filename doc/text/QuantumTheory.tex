...
The virial theorem relates the kinetic energy to the potential energy, and makes it possible to find the average kinetic energy even for complex systems. The classical statement of the theorem was formulated during the 19th century and named by Rudolf Clausius in 1870, \cite{clausius_xvi._1870} and in 1930 Vladimir Fock managed to prove the quantum virial theorem. \cite{fock_bemerkung_1930} The theorem can be expressed as
\begin{equation}
2\langle \mathcal{T} \rangle = \sum_{i}n_i\langle \mathcal{V}_{i} \rangle
\end{equation}
for sources of potential energy on the form
\begin{equation}
\mathcal{V}_{i}=ar^{n_i}.
\end{equation}

The expectation value is in principle the time average of the operator. However, if the ergodic hypothesis hold for the system, an ensemble average can also be taken. This is exactly what we gonna do...
