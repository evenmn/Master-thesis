...
To minimize the potential energy, the distances between all electron neighbors should be the same. For that reason, the electron density should only have discrete radial values, and the phenomenon should be observable in one-body density plots.
