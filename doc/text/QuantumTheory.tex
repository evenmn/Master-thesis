...
In 1905, Albert Einstein published a paper which explained the photoelectric effect based on Max Planck's idea of discrete energies. This is considered as the the beginning of the quantum theory.\footnote{The same year, Einstein presented his special theory of relativity, followed by the general theory of relativity in 1915. This theory superseded a 200-year-old theory of mechanics created primarily by Isaac Newton.} The years after this discovery, immense efforts were placed on completing the theory, and contributions from an array of scientists over a period of more than 20 years were necessary to get it complete. 

Key people include Niels Bohr, who developed a model to explain the spectral lines in atoms, Max Born who suggested the now-standard interpretation of the probability density function, Werner Heisenberg who formulated the matrix mechanics of quantum mechanics, Erwin Schrödinger who formulated the wave mechanics of quantum mechanics and Paul Dirac who contributed to complete the theory. We will meet them again in other parts of the thesis.

In 1929, Paul Dirac stated something similar to what some scientists claimed in the early 20th century, but apparently more correctly. \cite{dirac_paul_adrien_maurice_quantum_1929}
...
\end{equation}
which not necessarily is trivial to solve. If we take the wave function squared we get the probability distribution function,
\begin{equation}
...
In equation \eqref{eq:energyintegral}, we find the expectation value of the energy using the Hamiltonian, which is the energy operator. However, this relation applies for a general expectation value $\langle \mathcal{\hat{O}}\rangle$ related to an operator $\mathcal{\hat{O}}$,
\begin{equation}
\langle \mathcal{\hat{O}}\rangle=\frac{\int d\bs{r}\psinc\hat{\mathcal{O}}\psin}{\int d\bs{r}\psinc\psin}.
\label{eq:generalexp}
\end{equation}
As a consequence, there is always a uncertainty associated with a measurement in quantum physics, which means that we can only tell the probability of measuring something. From this, a variety of mathematical inequalities follows, where Heisenberg's uncertainty principle is the most famous. It states that the more precisely the position of some particle is determined, the less precisely its momentum can be known, and is mathematically presented as
\begin{equation}
...
\begin{equation}
\langle \mathcal{\hat{O}}\rangle=\frac{\mel{\Psi}{\mathcal{\hat{O}}}{\Psi}}{\braket{\Psi}{\Psi}}
\end{equation}
...
\begin{equation}
\langle \mathcal{\hat{O}}\rangle=\mel{\Psi}{\mathcal{\hat{O}}}{\Psi},
\end{equation}
...
The virial theorem relates the kinetic energy and potential energy, and makes it possible to find the average kinetic energy even for very complicated systems. The classical statement of the theorem has been known for a long time, and 1930 Vladimir Fock managed to prove the quantum virial theorem. \cite{fock_bemerkung_1930} The theorem can be expressed as
\begin{equation}
2\langle \mathcal{\hat{T}} \rangle = \sum_{i}n_i\langle \mathcal{\hat{V}}_{i} \rangle
\end{equation}
for sources to potential energy on the form
\begin{equation}
\mathcal{\hat{V}}_{i}=xr^{n_i}.
\end{equation}

The expectation value is in principle the time average of the operator. However, if the ergodic hypothesis hold for the system, an ensemble average can also be taken.
