...
\begin{axis}[name=2D, xlabel=Number of particles, ylabel={CPU-time [s]}, grid=major, 
legend cell align={left},
legend style={at={(1.68,1.05)}, anchor=south east, draw=white!80.0!black},
legend columns = 6, 
xtick=data] 
...
\begin{axis}[name=2D, xshift=7.9cm, xlabel=Number of particles, grid=major, xtick=data] 
\addplot[color=color0,mark=oplus*, dashed] coordinates { 
	(2,7.69)
	(8,20.92)
	(20,59.67) 
