...
% Define outputs
\node[] (center) {};
\node[input, above=0.3em of center] (y1) {$\tilde{y}_1$};
\node[input, below=0.3em of center] (y2) {$\tilde{y}_2$};
...
\path[draw,->] (aL4) -- (y1);
\path[draw,->] (aL5) -- (y1);
\path[draw,->] (bL) -- (y1) node[midway,above,xshift=3mm,yshift=1mm] {$b_{1}^{(L)}$};

\path[draw,->] (aL1) -- (y2);
\path[draw,->] (aL2) -- (y2);
\path[draw,->] (aL3) -- (y2);
\path[draw,->] (aL4) -- (y2);
\path[draw,->] (aL5) -- (y2) node[midway,below] {$w_{52}^{(L)}$};
\path[draw,->] (bL) -- (y2);
...
\path[draw,->] (x3) -- (a13);
\path[draw,->] (x3) -- (a14);
\path[draw,->] (x3) -- (a15) node[midway,below] {$w_{35}^{(0)}$};

\path[draw,->] (b0) -- (a11) node[midway,above] {$b_{1}^{(0)}$};
\path[draw,->] (b0) -- (a12);
\path[draw,->] (b0) -- (a13);
\path[draw,->] (b0) -- (a14);
\path[draw,->] (b0) -- (a15);
...
\path[draw,dashed,->] (a15) -- (al5) node[midway,below] {$w_{55}^{(1)}$};

\path[draw,dashed,->] (b1) -- (al1) node[midway,above] {$b_{1}^{(1)}$};
...
\path[draw,dashed,->] (bl) -- (aL1) node[midway,above] {$b_{1}^{(l)}$};
