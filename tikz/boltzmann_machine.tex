...
\draw[color0,thick,-] (b) to [out=315,in=90] (s6); 
\draw[color0,thick,-] (b) to [out=225,in=90] (s1);
\draw[color0,thick,-] (b) to [out=337.5,in=90] (s5);
\draw[color0,thick,-] (b) to [out=202.5,in=90] (s2);
\draw[color0,thick,-] (b) to [out=0,in=0,distance=3cm] (s4);
\draw[color0,thick,-] (b) to [out=180,in=180,distance=3cm] (s3) node[] at (-1.5,0) {$b_3$};
