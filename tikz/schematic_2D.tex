\begin{figure}
	\begin{center}
		...
		(-1.2,3.7) -- (2.2,3.7) node [black,midway,xshift=0.0cm, yshift=18pt] 
		{$n=0$};
		\end{scope}
		...
		\draw [decorate,decoration={brace,amplitude=10pt},xshift=0pt,yshift=0pt]
		(-5.2,3.7) -- (10.2,3.7) node [black,midway,xshift=0.0cm, yshift=18pt] 
		{$n=3$};
		\end{scope}
	...
	\begin{center}
		...
		\filldraw[color=color0] (0,1) circle (0.25cm);
		\draw [decorate,decoration={brace,amplitude=10pt},xshift=0pt,yshift=0pt]
		(-1.2,3.7) -- (6.2,3.7) node [black,midway,xshift=0.0cm, yshift=18pt] 
		{$n=1$};
		\end{scope}
		...
		\filldraw[color=color0] (1,1) circle (0.25cm);
		\draw [decorate,decoration={brace,amplitude=10pt},xshift=0pt,yshift=0pt]
		(-5.2,3.7) -- (6.2,3.7) node [black,midway,xshift=0.0cm, yshift=18pt] 
		{$n=2$};
		\end{scope}
		\begin{scope}[xshift=17cm]
		\foreach \i in {1,...,4}
