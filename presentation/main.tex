...
\mframe{Why quantum dots?}{}{
	\begin{itemize}
		\item Technology \supercite{noauthor_samsung_nodate, manders_8.3:_2015}
		\item Experimentally \supercite{brunner_sharp-line_1994}
		\item Physically
	\end{itemize}
}
...
\mframe{Why is it challenging?}{}{
	\begin{itemize}
		...
		\item NP-hard to compute the wave function
	\end{itemize}
}
