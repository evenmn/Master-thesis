...
\mframe{\frametitle{Why quantum dots?}
	\begin{itemize}
		\item Technology
		\item Theoretically
		\item Experimentally
...
\mframe{\frametitle{Why is it challenging?}
	\begin{itemize}
...
\mframe{\frametitle{How to overcome the challenges?}
	\begin{itemize}
		\item Efforts..
		\item gh
		\item Our approach: Machine Learning
	\end{itemize}
}
