...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{lR{1.5cm}R{1.6cm}R{1.6cm}R{1.5cm}R{1.3cm}} 
		\toprule
		$\omega$ & RBM & RBM+SJ & RBM+PJ & HF \footnote{\citet{mariadason_quantum_2018}} & Exact \footnote{\citet{taut_two_1993}} \\
		\midrule
...
\begin{table}
	\caption{$N=20$}
	\begin{tabularx}{\hsize}{lR{1.6cm}R{1.6cm}R{1.6cm}R{1.6cm}R{1.6cm}R{1.6cm}} \\
		\toprule
		$\omega$ & RBM & RBM+SJ & RBM+PJ & HF \footnote{\citet{mariadason_quantum_2018}} & VMC & DMC \footnote{\citet{hogberget_quantum_2013}} \\
		\midrule
