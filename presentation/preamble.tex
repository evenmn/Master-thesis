...
\usepackage[duration=35, lastminutes=10]{pdfpcnotes} % Display frames and notes separately
...
\definecolor{myblue}{rgb}{0.6, 0.6, 1}
\definecolor{myred}{rgb}{1,0.8,0.856862745098039}
